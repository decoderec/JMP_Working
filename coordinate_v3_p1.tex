...
%\multicolumn{4}{c}{The belief of $j\in G_i$ after observing $i$'s previous actions immediately after $\Omicron^t$}\\
% $i$ plays  	&&	&	 The event $j\in G_i$ assigns with probability one \\
%\hline
%\hline
% In $\Omicron^t$		&&&					 \\
...
%\hline
%\multicolumn{4}{c}{The belief of $j\in G_i$ after observing $i$'s previous actions immediately after $\Kappa^t_1$ {contingent} on $\Omicron^t$}\\
% $i$ plays	&&			  & The event $j\in G_i$ assigns with probability one \\
%\hline
%\hline
...
%\hline
%\multicolumn{4}{c}{The belief of $j\in G_i$ after observing $i$'s previous actions immediately after $\Kappa^t_{2}$ {contingent} on $\Omicron^t$, $\Kappa^t_{1}$, and $\Kappa^t_{2}$}\\
% $i$ plays  	&		&  	  &The event $j\in G_i$ assigns with probability one\\
%\hline
%\hline
