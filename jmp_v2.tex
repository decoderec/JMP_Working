...
\item Such $j$ has $\#I^{|RP^t|}_j=\#I^t_j<k$. Since there is no more Rebel outside $I^{|RP^t|,t}_j\cup I^{|RP^t|,t}_i$ contingent on $E$, such $j$ will then play \text{stay} forever after $t$-block.
