...
%$i$ is the free rider in $\Omicron^t$  &  						& $\langle 1 \rangle_m$ 		& 										  & to $m+1$-register in $\Kappa^t_{1,1}$  \\
%$i$ is $k-1$-pivotal in $\Omicron^t$ 	&  						& $\langle 1 \rangle_m$ 	& 											 & to $m+1$-register in $\Kappa^t_{1,1}$  \\
\hline
\end{tabular}
\end{center}
\end{table}
...
from $i$ 	 & from $G_i$	  & 	&	 & \\
\hline
%$I^{t+1}_i\geq k$  	&                                & 											&				 				& to terminal \textbf{s}\\
